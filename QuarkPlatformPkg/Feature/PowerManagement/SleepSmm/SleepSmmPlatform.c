...
UINT32                           mPciExpPerstResumeWellGpio;
...
--*/
{
  ...
  mPciExpPerstResumeWellGpio = PcdGet32(PcdPciExpPerstResumeWellGpio);
...
--*/
{
  ...
  //
  PlatformPERSTAssert (mPciExpPerstResumeWellGpio);
