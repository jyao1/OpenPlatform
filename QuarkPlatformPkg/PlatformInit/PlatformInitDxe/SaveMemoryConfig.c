...
/*++
  ...
  Routine Description:
	...
	This work is done in VariableWriteArch notify handler.
...
--*/
{
  ...
  EfiCreateProtocolNotifyEvent (&gEfiVariableWriteArchProtocolGuid, TPL_CALLBACK, SaveMemoryConfigCallback, NULL, &Registration);
